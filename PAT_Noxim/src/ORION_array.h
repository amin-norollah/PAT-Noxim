...
extern int SIM_array_power_init(SIM_array_info_t *info, SIM_array_t *arr, double temperature );
...
extern double SIM_array_stat_energy(SIM_array_info_t *info, SIM_array_t *arr, double n_read, double n_write, int max_avg);
