...
extern int SIM_router_init(SIM_router_info_t *info, SIM_router_power_t *SIM_router_power, SIM_router_area_t *SIM_router_area, int num_vc, int buffer_size, double temperature);
...
extern int SIM_router_power_init(SIM_router_info_t *info, SIM_router_power_t *router, double temperature);
extern int SIM_router_power_report(SIM_router_info_t *info, SIM_router_power_t *router);

extern double SIM_router_report_Estatic(SIM_router_power_t *router);
extern double SIM_router_report_Edynamic(SIM_router_info_t *info, SIM_router_power_t *router, int _switch);

extern int SIM_router_area_init(SIM_router_info_t *info, SIM_router_area_t *SIM_router_area);
extern double SIM_router_area(SIM_router_area_t *SIM_router_area, int _switch);
