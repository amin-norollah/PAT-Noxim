...
package_config_t default_package_config(void)
{
	...
	/* default sink specs */
		 ...
		 * 1) fin-channel sink 
		 */
	config.fin_height = 120e-3;
	config.fin_width = 3e-3;
	config.channel_width = 4e-3;
		/* 2) pin-fin sink */
	config.pin_height = 40e-3;
	config.pin_diam = 2e-3;
	config.pin_dist = 5e-3;
	
	/* fan specs */
	config.fan_radius = 60e-3;
	config.motor_radius = 20e-3;
	config.rpm = 3590;  //5000 //4000 //1000
