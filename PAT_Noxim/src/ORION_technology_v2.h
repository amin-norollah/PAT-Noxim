...
/* This file contains parameters for 65nm, 45nm, 32nm and 22nm */
...
/* scaling factors from 65nm to 45nm, 32nm and 22nm*/
...
#define SCALE_T (0.6285107)
#define SCALE_M (0.3740891)
#define SCALE_S (3.1133604)
#define SCALE_W (0.2) 
#define SCALE_H (0.65) 
#define SCALE_BW (0.45) 
#define SCALE_Crs (0.377) 
#elif (PARM(TECH_POINT) == 22 && PARM(TRANSISTOR_TYPE) == NVT)
#define SCALE_T (0.4886227)
#define SCALE_M (0.3740891)
#define SCALE_S (2.594465)
#define SCALE_W (0.2) 
#define SCALE_H (0.65) 
#define SCALE_BW (0.45) 
#define SCALE_Crs (0.377) 
#elif (PARM(TECH_POINT) == 22 && PARM(TRANSISTOR_TYPE) == HVT)
#define SCALE_T (0.3687187)
#define SCALE_M (0.3740891)
#define SCALE_S (2.3202373)
#define SCALE_W (0.2) 
#define SCALE_H (0.65) 
#define SCALE_BW (0.45) 
#define SCALE_Crs (0.377) 
...
#elif(PARM(TECH_POINT) <= 22) /* PARAMETERS for Link at 22nm */
#if (WIRE_LAYER_TYPE == LOCAL)
#define WireMinWidth                    22e-9
#define WireMinSpacing                  22e-9
#define WireMetalThickness              45.8e-9
#define WireBarrierThickness            2.2e-9
#define WireDielectricThickness         40.8e-9  //need edit
#define WireDielectricConstant          1.8      //need edit
...
#define WireMetalThickness          45.8e-9
#define WireBarrierThickness        2.2e-9
#define WireDielectricThickness     34.4e-9 //need edit
#define WireDielectricConstant      1.8     //need edit

#elif (WIRE_LAYER_TYPE == GLOBAL)
#define WireMinWidth                44e-9
#define WireMinSpacing              44e-9
#define WireMetalThickness          91.6e-9
#define WireBarrierThickness        2.2e-9
#define WireDielectricThickness     75.4e-9 //need edit
#define WireDielectricConstant      1.8      //need edit

#endif /* WIRE_LAYER_TYPE for 22nm*/
...
#define ResistanceFactor			8.56e-7
#define CapacitanceFactor			0.83e-4
#if(PARM(TRANSISTOR_TYPE) == LVT)
...
#define ResistanceFactor			2.87e-7
#define CapacitanceFactor			0.85e-4
#if(PARM(TRANSISTOR_TYPE) == LVT)
...
#define ResistanceFactor			1.03e-8
#define CapacitanceFactor			0.95e-4
#if(PARM(TRANSISTOR_TYPE) == LVT)
...
#define ResistanceFactor			1e-8
#define CapacitanceFactor			1e-4
#if(PARM(TRANSISTOR_TYPE) == LVT)
...
#endif
/*parameters for insertion buffer for links at 22nm*/
#elif(PARM(TECH_POINT) == 22)
#define BufferDriveResistance       12.9717e+03
#define BufferIntrinsicDelay        3.6e-11
#define ResistanceFactor			0.9e-8
#define CapacitanceFactor			1.15e-4
#if(PARM(TRANSISTOR_TYPE) == LVT)
#define BufferPMOSOffCurrent        2218.92e-09 
#define BufferNMOSOffCurrent        767.558e-09
#define BufferInputCapacitance      1.1e-15 
#define ClockCap                    1.9e-14
#elif(PARM(TRANSISTOR_TYPE) == NVT)
#define BufferPMOSOffCurrent        1259.91e-09 
#define BufferNMOSOffCurrent        866.914e-09
#define BufferInputCapacitance      2.3e-15 
#define ClockCap                    1.4e-14
#elif(PARM(TRANSISTOR_TYPE) == HVT)
#define BufferPMOSOffCurrent        194.85e-09 
#define BufferNMOSOffCurrent        85.656e-09
#define BufferInputCapacitance      6.5e-15 
#define ClockCap                    0.47e-15
#endif
#endif /*PARM(TECH_POINT)*/
...
#define AreaTristate	(2.88 * SCALE_T) 
