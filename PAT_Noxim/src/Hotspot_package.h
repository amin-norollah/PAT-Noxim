...
#define AIR_DSTY		2.159	/* density */     //1.059
#define AIR_SPECHT		10407 /* specific heat */  //1007
#define AIR_COND	0.028	/* thermal conductivity */ //0.028
#define AIR_DIFF	2.6e-5	/* thermal diffusivity */ //2.6e-5
